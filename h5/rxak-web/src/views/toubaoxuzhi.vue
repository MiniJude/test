...
-->
<template>
    <div class="toubaoxuzhi">
        <div class="list">
            <div class="list_item" v-for="item in list">
                <div class="list_item_label">{{ item.label }}</div>
...
const list = [
    { label: '投保年龄', desc: '出生满30日（含）至60周岁' },
    { label: '保险期间', desc: '至被保险人年满80周岁后的首个保单周年日24时，终身' },
    { label: '交费期间', desc: '5年，10年，15年，20年，30年' },
    { label: '交费方式', desc: '年交，月交' },
]

</script>
<style lang="less">
.modal-wrapper .modal:has(.toubaoxuzhi) {
    max-height: 90vh;
    display: flex;
