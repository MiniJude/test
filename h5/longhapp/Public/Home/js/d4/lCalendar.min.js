...
window.lCalendar = function() {
    ...
    return a.prototype = {
        init: function(a) {
            if (this.type = a.type,
            this.trigger = document.querySelector(a.trigger),
        ...
        bindEvent: function(a) {
            ...
            function c() {
                ...
                /^\d{4}-\d{1,2}-\d{1,2}$/.test(t.trigger.value) ? (rs = t.trigger.value.match(/(^|-)\d{1,4}/g),
                b.yy = rs[0] - t.minY,
                b.mm = rs[1].replace(/-/g, "") - 1,
                b.dd = rs[2].replace(/-/g, "") - 1) : b.yy = b.yy + 1900 - t.minY,
            ...
            function e() {
                ...
                /^\d{4}-\d{1,2}-\d{1,2}\s\d{2}:\d{2}$/.test(t.trigger.value) ? (rs = t.trigger.value.match(/(^|-|\s|:)\d{1,4}/g),
                b.yy = rs[0] - t.minY,
                b.mm = rs[1].replace(/-/g, "") - 1,
                b.dd = rs[2].replace(/-/g, "") - 1,
                b.hh = parseInt(rs[3].replace(/\s0?/g, "")),
                b.mi = parseInt(rs[4].replace(/:0?/g, ""))) : b.yy = b.yy + 1900 - t.minY,
                t.gearDate.querySelector(".date_yy").setAttribute("val", b.yy),
                t.gearDate.querySelector(".date_mm").setAttribute("val", b.mm),
                t.gearDate.querySelector(".date_dd").setAttribute("val", b.dd),
                h(),
            ...
            function h() {
                ...
                if (b && b.getAttribute("val")) {
                    ...
                    if (h && h.getAttribute("val")) {
                        ...
                        h.innerHTML = c,
                        i > k ? (i = k,
                        h.setAttribute("val", i)) : l > i && (i = k,
                        h.setAttribute("val", i)),
                        ...
                        if (m && m.getAttribute("val")) {
                            ...
                            m.innerHTML = c,
                            n > p ? (n = p,
                            m.setAttribute("val", n)) : q > n && (n = q,
                            m.setAttribute("val", n)),
            ...
            function j(a, b) {
                return 1 == b ? (a += t.minY,
                a % 4 == 0 && a % 100 != 0 || a % 400 == 0 && a % 4e3 != 0 ? 29 : 28) : 3 == b || 5 == b || 8 == b || 10 == b ? 30 : 31
            }
            function k(a) {
                a.preventDefault();
                for (var b = a.target; ; ) {
